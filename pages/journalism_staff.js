        ...
        <div className={styles.topWrapper}>
            <div className={styles.textWrapper}>
                ...
                <span style={{'whiteSpace': 'pre-line'}}>
                    {data.description ? data.description : "The Pacific Crest journalism team is comprised of motivated students that write articles on the regular for the both this website and the physical Goat Scene and Herd paper.\n\nThis semester's students include:"}
